...
mymodel,X_train1 = model(data_frame)
test_data['day_mean'] = test_data['day_of_week'].map(flag_to_number)
#test_data['day_std'] = test_data['day_of_week'].map(flag_to_number1)
#test_data['day_75'] = test_data['day_of_week'].map(flag_to_number4)
...
#y_test.loc[:,'pre'] = y_pre1
#y_test.to_csv('test.csv',index = None,header = None)
sum = 0.0
